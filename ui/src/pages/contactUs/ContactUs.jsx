...
export default function ContactUs() {
	...
	const handleSubmit = event => {
		...
		if (isValid) {
			const mailtoLink = `mailto:joe.smith@hc-sc.gc.ca?subject=${encodeURIComponent(formData.subject)}&body=${encodeURIComponent(
			...
			{submitted ? (
				...
				<div>
					<GcdsText characterLimit="false">
						{t("pages.contactUs.subTitle")} <a href="mailto:joe.smith@hc-sc.gc.ca">joe.smith@hc-sc.gc.ca</a>.
					</GcdsText>
